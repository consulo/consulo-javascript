...
public class EquivalenceChecker {
    ...
    public static boolean statementsAreEquivalent(JSStatement exp1, JSStatement exp2) {
        ...
        switch (type1) {
            case BLOCK_STATEMENT:
                return codeBlocksAreEquivalent((JSBlockStatement)exp1, (JSBlockStatement)exp2);
            case BREAK_STATEMENT:
                return breakStatementsAreEquivalent((JSBreakStatement)exp1, (JSBreakStatement)exp2);
            case CONTINUE_STATEMENT:
                return continueStatementsAreEquivalent((JSContinueStatement)exp1, (JSContinueStatement)exp2);
            case VAR_STATEMENT:
                return declarationStatementsAreEquivalent((JSVarStatement)exp1, (JSVarStatement)exp2);
            case DO_WHILE_STATEMENT:
                return doWhileStatementsAreEquivalent((JSDoWhileStatement)exp1, (JSDoWhileStatement)exp2);
            case EMPTY_STATEMENT:
                return true;
            case EXPRESSION_STATEMENT:
                return expressionStatementsAreEquivalent((JSExpressionStatement)exp1, (JSExpressionStatement)exp2);
            case FOR_STATEMENT:
                return forStatementsAreEquivalent((JSForStatement)exp1, (JSForStatement)exp2);
            case FOR_IN_STATEMENT:
                return forInStatementsAreEquivalent((JSForInStatement)exp1, (JSForInStatement)exp2);
            case IF_STATEMENT:
                return ifStatementsAreEquivalent((JSIfStatement)exp1, (JSIfStatement)exp2);
            case LABELED_STATEMENT:
                return labeledStatementsAreEquivalent((JSLabeledStatement)exp1, (JSLabeledStatement)exp2);
            case RETURN_STATEMENT:
                return returnStatementsAreEquivalent((JSReturnStatement)exp1, (JSReturnStatement)exp2);
            case SWITCH_STATEMENT:
                return switchStatementsAreEquivalent((JSSwitchStatement)exp1, (JSSwitchStatement)exp2);
            case THROW_STATEMENT:
                return throwStatementsAreEquivalent((JSThrowStatement)exp1, (JSThrowStatement)exp2);
            case TRY_STATEMENT:
                return tryStatementsAreEquivalent((JSTryStatement)exp1, (JSTryStatement)exp2);
            case WHILE_STATEMENT:
                return whileStatementsAreEquivalent((JSWhileStatement)exp1, (JSWhileStatement)exp2);
            case WITH_STATEMENT:
                return withStatementsAreEquivalent((JSWithStatement)exp1, (JSWithStatement)exp2);
            default:
                return false;
        }
    }
    ...
    private static boolean tryStatementsAreEquivalent(JSTryStatement statement1, JSTryStatement statement2) {
        ...
        if (!statementsAreEquivalent(
            statement1.getFinallyStatement(),
        ...
        if (!parametersAreEquivalent(
            catchBlock1.getParameter(),
            catchBlock2.getParameter()
        )) {
            return false;
        }
        return statementsAreEquivalent(
            catchBlock1.getStatement(),
    ...
    private static boolean switchStatementsAreEquivalent(JSSwitchStatement statement1, JSSwitchStatement statement2) {
        if (!expressionsAreEquivalent(statement1.getSwitchExpression(), statement2.getSwitchExpression())) {
            return false;
        }
    ...
    public static boolean expressionsAreEquivalent(JSExpression exp1, JSExpression exp2) {
        ...
        switch (type1) {
            ...
            case CALL_EXPRESSION:
                return callExpressionsAreEquivalent((JSCallExpression)expToCompare1, (JSCallExpression)expToCompare2);

            case NEW_EXPRESSION:
                return newExpressionsAreEquivalent((JSNewExpression)expToCompare1, (JSNewExpression)expToCompare2);

            case ARRAY_LITERAL_EXPRESSION:
                return arrayLiteralExpressionsAreEquivalent(
                    (JSArrayLiteralExpression)expToCompare1,
                    (JSArrayLiteralExpression)expToCompare2
                );

            case PREFIX_EXPRESSION:
                return prefixExpressionsAreEquivalent((JSPrefixExpression)expToCompare1, (JSPrefixExpression)expToCompare2);

            case POSTFIX_EXPRESSION:
                return postfixExpressionsAreEquivalent((JSPostfixExpression)expToCompare1, (JSPostfixExpression)expToCompare2);

            case BINARY_EXPRESSION:
                return binaryExpressionsAreEquivalent((JSBinaryExpression)expToCompare1, (JSBinaryExpression)expToCompare2);

            case ASSIGNMENT_EXPRESSION:
                return assignmentExpressionsAreEquivalent((JSAssignmentExpression)expToCompare1, (JSAssignmentExpression)expToCompare2);

            case CONDITIONAL_EXPRESSION:
                return conditionalExpressionsAreEquivalent((JSConditionalExpression)expToCompare1, (JSConditionalExpression)expToCompare2);

            case INDEX_PROPERTY_ACCESS_EXPRESSION:
                return indexedPropertyAccessExpressionsAreEquivalent(
                    (JSIndexedPropertyAccessExpression)expToCompare1,
                    (JSIndexedPropertyAccessExpression)expToCompare2
                );

            case OBJECT_LITERAL_EXPRESSION:
                return objectLiteralExpressionsAreEquivalent(
                    (JSObjectLiteralExpression)expToCompare1,
                    (JSObjectLiteralExpression)expToCompare2
                );

            case FUNCTION_EXPRESSION:
                return functionExpressionsAreEquivalent((JSFunctionExpression)expToCompare1, (JSFunctionExpression)expToCompare2);
    ...
    private static boolean objectLiteralExpressionsAreEquivalent(
    ...
    private static boolean indexedPropertyAccessExpressionsAreEquivalent(
    ...
    private static boolean arrayLiteralExpressionsAreEquivalent(
