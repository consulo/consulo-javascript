...
public class ControlFlowUtils {
    ...
    public static boolean isInLoopStatementBody(@NotNull PsiElement element) {
    ...
    @NotNull public static List<JSCallExpression> getRecursiveCalls(@NotNull JSFunction function) {
