...
public class JSDocumentationProvider implements CodeDocumentationProvider {
  ...
  @NonNls private static final String OBJECT_NAME = "Object";
  protected static final String SEE_PLAIN_TEXT_CHARS = "\t \"-\\/<>*";

  @NonNls protected static final String PACKAGE = "package";
  @NonNls protected static final String HTML_EXTENSION = ".html";
  @NonNls protected static final String PACKAGE_FILE = PACKAGE + HTML_EXTENSION;
  ...
  public String getQuickNavigateInfo(PsiElement element) {
    ...
    if (element instanceof JSFunction) {
      ...
      if (function.isConstructor()) {
        if (parent instanceof JSClass) return createQuickNavigateForClazz((JSClass)parent);
      }
  ...
  String createQuickNavigateForFunction(final JSFunction function) {
    ...
    if (!get && !set) {
      ...
      if (jsParameterList != null) {
        ...
        for (JSParameter p : jsParameterList.getParameters()) {
          if (start != result.length()) result.append(", ");
    ...
    if (varType != null) result.append(':').append(varType);
  ...
  String createQuickNavigateForVariable(final JSVariable variable) {
    ...
    if (s != null) result.append(" = ").append(s);
    return result.toString();
  }
  ...
  private static void appendVarType(final JSVariable variable, final StringBuilder builder) {
    ...
    if (varType != null) builder.append(':').append(varType);
  }
  ...
  String createQuickNavigateForClazz(final JSClass jsClass) {
    ...
    if (s == null && !OBJECT_NAME.equals(name)) s = OBJECT_NAME;
    if (s != null) result.append(" extends ").append(s);

    s = generateReferenceTargetList(jsClass.getImplementsList(), packageName);
    if (s != null) result.append("\nimplements ").append(s);
  ...
  private static void appendAttrList(final JSAttributeListOwner jsClass, final StringBuilder result) {
    ...
    if (attributeList != null) {
      if (attributeList.hasModifier(JSAttributeList.ModifierType.OVERRIDE)) result.append("override ");
      ...
      if (attributeList.hasModifier(JSAttributeList.ModifierType.STATIC)) result.append("static ");
      if (attributeList.hasModifier(JSAttributeList.ModifierType.FINAL)) result.append("final ");
      if (attributeList.hasModifier(JSAttributeList.ModifierType.DYNAMIC)) result.append("dynamic ");
      if (attributeList.hasModifier(JSAttributeList.ModifierType.NATIVE)) result.append("native ");
    }
  }
  ...
  private static PsiElement findFirstDocComment(PsiElement docComment) {
    if (docComment.getNode().getElementType() == JSTokenTypes.END_OF_LINE_COMMENT) {
      while (true) {
        ...
        if (prev == null) break;
        if (prev.getNode().getElementType() != JSTokenTypes.END_OF_LINE_COMMENT) break;
        docComment = prev;
      }
    }
    return docComment;
  ...
  public PsiElement getDocumentationElementForLookupItem(PsiManager psiManager, Object object, PsiElement element) {
    if (object instanceof LookupValueWithPsiElement) object = ((LookupValueWithPsiElement)object).getElement();
    if (object instanceof JSNamedElementProxy) object = ((JSNamedElementProxy)object).getElement();
    final PsiElement psiElement = findElementForWhichPreviousCommentWillBeSearched(object);
    if (psiElement != null && JSDocumentationUtils.findDocComment(psiElement) != null) return psiElement;
    ...
    if (object instanceof JSFunction) {
          ...
          if (!(el instanceof PsiWhiteSpace) && !(el instanceof PsiComment)) {
            if (el instanceof JSFunction) {
              ...
              if (name != null &&
                ...
                if (doc != null) return prevFunction;
              }
            }
            break;
          }
      ...
      if (parent instanceof JSAssignmentExpression) {
        ...
        if (grandParent.getFirstChild() == parent) {
          ...
          if (element instanceof JSFile) return grandParent;
          return element;
        }
        return parent;
      }
  ...
  public String generateDocumentationContentStub(PsiComment contextComment) {
    for (PsiElement el = contextComment.getParent(); el != null; el = el.getNextSibling()) {
      if (el instanceof JSProperty) {
        ...
        if (propertyValue instanceof JSFunction) return doGenerateDoc((JSFunction)propertyValue);
      }
