...
public interface JSTokenTypes {  
  ...
  IElementType DOC_COMMENT = new JSChameleonElementType("DOC_COMMENT") {
    ...
    @Override
    protected @Nullable Lexer createLexer() {
  ...
  TokenSet XML_TOKENS = TokenSet.create(XML_START_TAG_START, XML_START_TAG_LIST, XML_END_TAG_LIST, XML_END_TAG_START, XML_EMPTY_TAG_END,
    XML_NAME,
    XML_TAG_NAME,
    XML_ATTR_EQUAL,
    XML_ATTR_VALUE,
  ...
  TokenSet JS_KEYWORDS = TokenSet.create(
  ...
  TokenSet JS2_KEYWORDS = TokenSet.create( PACKAGE_KEYWORD, PROTECTED_KEYWORD, INTERNAL_KEYWORD, DYNAMIC_KEYWORD, FINAL_KEYWORD, NATIVE_KEYWORD,
                                           PRIVATE_KEYWORD, PUBLIC_KEYWORD, VIRTUAL_KEYWORD,
                                           STATIC_KEYWORD, PUBLIC_KEYWORD, CLASS_KEYWORD, INTERFACE_KEYWORD, EXTENDS_KEYWORD,
                                           IMPLEMENTS_KEYWORD, IMPORT_KEYWORD, USE_KEYWORD, NAMESPACE_KEYWORD, OVERRIDE_KEYWORD,
                                           INCLUDE_KEYWORD, SUPER_KEYWORD, IS_KEYWORD, AS_KEYWORD, GET_KEYWORD, SET_KEYWORD, EACH_KEYWORD,
                                           INT_KEYWORD, UINT_KEYWORD
                                         );
  ...
  TokenSet OPERATIONS = TokenSet.create(
    ...
    OREQ, XOREQ, DIV, DIVEQ, COMMA, IS_KEYWORD, AS_KEYWORD
  );
  ...
  TokenSet COMMENTS = TokenSet.create(
    ...
    XML_STYLE_COMMENT_START, JavaScriptHighlightingLexer.getTagContentTokenType(), XML_TAG_WHITE_SPACE, JSP_TEXT,
    JSDOC_TAG_DATA
  );

  TokenSet MODIFIERS = TokenSet.create(
    PUBLIC_KEYWORD, STATIC_KEYWORD, OVERRIDE_KEYWORD, PROTECTED_KEYWORD, PRIVATE_KEYWORD,
    INTERNAL_KEYWORD, DYNAMIC_KEYWORD, FINAL_KEYWORD, NATIVE_KEYWORD, VIRTUAL_KEYWORD
  );

  TokenSet ACCESS_MODIFIERS = TokenSet.create(
    PUBLIC_KEYWORD, PROTECTED_KEYWORD, PRIVATE_KEYWORD,
    INTERNAL_KEYWORD
  );

  TokenSet IDENTIFIER_TOKENS_SET = TokenSet.create(
    IDENTIFIER, NAMESPACE_KEYWORD, EACH_KEYWORD,GET_KEYWORD, SET_KEYWORD, GWT_FIELD_OR_METHOD, INT_KEYWORD, UINT_KEYWORD, UNDEFINED_KEYWORD,
    INCLUDE_KEYWORD, DYNAMIC_KEYWORD, FINAL_KEYWORD, NATIVE_KEYWORD, OVERRIDE_KEYWORD, STATIC_KEYWORD, LET_KEYWORD, YIELD_KEYWORD, VIRTUAL_KEYWORD,
    INTERNAL_KEYWORD
  );
