...
public class JSUnusedImportsHelper {
  ...
  public static class Results {
    ...
    public Results(Map<JSReferenceExpression, String> fqnsToReplaceWithImport,
  ...
  private static Pair<Boolean, Boolean> getReplaceStatus(JSReferenceExpression node, PsiElement resolve) {
    if (resolve == null) resolve = JSResolveUtil.findClassByQName(node.getText(), node);
    ...
    if (parent instanceof JSExpressionStatement &&
        !(resolve instanceof JSNamespaceDeclaration)) {
      return Pair.create(false, false);
    }
