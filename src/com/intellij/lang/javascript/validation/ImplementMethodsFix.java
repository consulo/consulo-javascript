...
public class ImplementMethodsFix extends BaseCreateMethodsFix<JSFunction> implements IntentionAction {
  ...
  protected @NonNls String buildFunctionAttrText(@NonNls String attrText, final JSAttributeList attributeList, final JSFunction function) {
  ...
  private static @NonNls String defaultValueOfType(final @NonNls String retType) {
    if ("int".equals(retType) || "uint".equals(retType) || "Number".equals(retType)) return "0";
    if ("Boolean".equals(retType)) return "false";
    return "null";
  }
