...
public class JSReferenceListStubImpl extends StubBase<JSReferenceList> implements JSReferenceListStub {
  ...
  public JSReferenceListStubImpl(final StubInputStream dataStream, final StubElement parentStub,
    ...
    myRefs = ArrayUtil.newStringArray(count);
      for(int i = 0; i < count; ++i) myRefs[i] = dataStream.stringFromId(dataStream.readInt());
  }

  public JSReferenceListStubImpl(final String[] refs,
  ...
  public JSReferenceListStubImpl(final JSReferenceList psi,
                                        final StubElement parentStub,
                                        final JSStubElementType<JSReferenceListStub, JSReferenceList> type) {
    super(parentStub, type);
  ...
  public void serialize(final StubOutputStream dataStream) throws IOException {
    ...
    for(String s:myRefs) dataStream.writeInt(dataStream.getStringId(s));
  }
