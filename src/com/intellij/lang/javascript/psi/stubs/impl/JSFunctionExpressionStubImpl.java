...
public class JSFunctionExpressionStubImpl extends JSFunctionStubBaseImpl<JSFunctionExpression> implements JSFunctionExpressionStub {
  ...
  public JSFunctionExpressionStubImpl(final StubInputStream dataStream, final StubElement parentStub, final JSStubElementType elementType) throws IOException {
