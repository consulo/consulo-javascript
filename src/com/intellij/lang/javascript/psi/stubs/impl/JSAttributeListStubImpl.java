...
public class JSAttributeListStubImpl extends StubBase<JSAttributeList> implements JSAttributeListStub {
  ...
  public JSAttributeListStubImpl(final StubInputStream dataStream, final StubElement parentStub, final IStubElementType elementType)
      throws IOException {
  ...
  private static int getFlagShift(final JSAttributeList.ModifierType modifier) {
    ...
    if (shift == -1) throw new IllegalArgumentException("Illegal modifier passed:"+modifier);
    return shift;
  }
