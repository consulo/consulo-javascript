...
public abstract class JSBaseClassBasedIntroduceDialog extends JSBaseIntroduceDialog {
  ...
  protected JSBaseClassBasedIntroduceDialog(final Project project,
  ...
  public JSAttributeList.AccessType getAccessType() {
    ...
    if (getPublicRadioButton().isSelected()) type = JSAttributeList.AccessType.PUBLIC;
    if (getPrivateRadioButton().isSelected()) type =  JSAttributeList.AccessType.PRIVATE;
    if (getPackageLocalRadioButton().isSelected()) type = JSAttributeList.AccessType.PACKAGE_LOCAL;
    if (getProtectedRadioButton().isSelected()) type = JSAttributeList.AccessType.PROTECTED;
    assert type != null;
    lastType = type;
    return type;
  }
