...
public JSFunctionStub newInstance(final StubInputStream dataStream, final StubElement parentStub,
                                  final JSStubElementType<JSFunctionStub, JSFunction> elementType) throws IOException {
    return new JSFunctionStubImpl(dataStream, parentStub, elementType);
  }

  public JSFunctionStub newInstance(final JSFunction psi, final StubElement parentStub,
                                    final JSStubElementType<JSFunctionStub, JSFunction> elementType) {
