...
public class JSNamespaceDeclarationElementType extends JSStubElementType<JSNamespaceDeclarationStub, JSNamespaceDeclaration> {
  private static final JSStubGenerator<JSNamespaceDeclarationStub,JSNamespaceDeclaration> ourStubGenerator = new JSStubGenerator<JSNamespaceDeclarationStub, JSNamespaceDeclaration>() {
