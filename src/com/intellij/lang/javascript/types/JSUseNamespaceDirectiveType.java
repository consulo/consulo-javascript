...
{
	private static JSStubGenerator<JSUseNamespaceDirectiveStub, JSUseNamespaceDirective> ourStubGenerator = new
			JSStubGenerator<JSUseNamespaceDirectiveStub, JSUseNamespaceDirective>()
	{
		@Override
