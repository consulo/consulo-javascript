...
public class JSNamespace {
  ...
  public JSNamespace(JSPackage _package) {
    myPackage = _package;
    if (_package != null) _package.addInstance(this);
  }
  ...
  public final JSNamespace findChildNamespace(final int nameId) {
    if (myChildNamespaces == null) return null;
  ...
  public void enumerateNames(final SerializationContext context) {
    if (myParent != null) context.addName(context.typeEvaluateManager.getBaseType(this));
  ...
  private void doRead(final DeserializationContext context, JSNamespace parent) throws IOException {
    ...
    if (myParent != null) {
      context.typeEvaluateManager.setBaseType(
        this,
        getQualifiedNameId(context.index), superNsType
      );
    }
  ...
  public int getQualifiedNameId(JavaScriptIndex index) {
    if (myParent instanceof JSRootNamespace) return getNameId();
  ...
  public final JSRootNamespace getRootNs() {
    JSNamespace ns = this;
    while(ns.myParent != null) ns = ns.getParent();
