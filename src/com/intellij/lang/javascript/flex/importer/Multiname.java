...
class Multiname {
  ...
  public String getNsName() {
    ...
    return nsset[0].equals("http://adobe.com/AS3/2006/builtin") ? "AS3" :
           ...
           nsset[0].equals("__AS3__.vec") ? "__AS3__$vec" :
           nsset[0].equals("http://www.adobe.com/2008/actionscript/Flash10/") ? "flash10" :
           nsset[0].equals("http://www.adobe.com/2006/actionscript/flash/objectproxy") ? "object_proxy":
           nsset[0].equals("http://www.adobe.com/2006/actionscript/flash/proxy") ? "flash_proxy":
           getValidNsName();
  }
