...
public class FlexImportSupport {
  ...
  public static JSImportedElementResolveResult tryFindInMap(final String referenceName,
  ...
  private static JSImportedElementResolveResult tryFindClass(final String referenceName, final PsiNamedElement file,
                                                             final Object entry, String qName) {
    ...
    if (qName != null && !qName.equals(nameToTry)) return null;
