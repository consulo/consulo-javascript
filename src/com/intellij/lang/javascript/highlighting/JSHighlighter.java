...
public class JSHighlighter extends SyntaxHighlighterBase {
  ...
  static final TextAttributesKey JS_LOCAL_VARIABLE = TextAttributesKey.createTextAttributesKey(
                                                    "JS.LOCAL_VARIABLE",
                                                    new TextAttributes(new Color(69, 131, 131), Color.white, null, null, 0)
                                                  );
  static final TextAttributesKey JS_PARAMETER = TextAttributesKey.createTextAttributesKey(
                                                    "JS.PARAMETER",
                                                    new TextAttributes(Color.black, Color.white, Color.black, EffectType.LINE_UNDERSCORE, 0)
                                                  );
  ...
  static final TextAttributesKey JS_METADATA = TextAttributesKey.createTextAttributesKey(
                                                    "JS.ATTRIBUTE",
                                                    new TextAttributes(null, new Color(0xf7, 0xe9, 0xe9), null, null, 0)
                                                  );
  ...
  static {
    ...
    SyntaxHighlighterBase.fillMap(keys1, JSTokenTypes.OPERATIONS, JS_OPERATION_SIGN); // we do need init OPERATIONS before KEYWORDS because has some OPERATIONS to be KEYWORDS (is, as)
    ...
    for(IElementType type:JSTokenTypes.XML_TOKENS.getTypes()) keys1.put(type, XmlHighlighterColors.XML_TAG);
