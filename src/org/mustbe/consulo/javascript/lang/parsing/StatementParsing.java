...
public class StatementParsing extends Parsing
{
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.YIELD_KEYWORD);
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.LET_KEYWORD);
		final PsiBuilder.Marker marker = builder.mark();
		builder.advanceLexer();
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.INCLUDE_KEYWORD);
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.TRY_KEYWORD);
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.CATCH_KEYWORD);
		final PsiBuilder.Marker block = builder.mark();
		builder.advanceLexer();
		checkMatches(builder, JSTokenTypes.LPAR, JavaScriptBundle.message("javascript.parser.message.expected.lparen"));
		...
		if(JSTokenTypes.IDENTIFIER_TOKENS_SET.contains(identifierType))
		{
			...
			if(!getExpressionParsing().tryParseType(builder))
			{
				...
				{
					builder.advanceLexer();
					checkMatches(builder, identifierType, JavaScriptBundle.message("javascript.parser.message.expected.identifier"));
					checkMatches(builder, JSTokenTypes.INSTANCEOF_KEYWORD, JavaScriptBundle.message("javascript.parser.message.expected.instanceof"));
					checkMatches(builder, JSTokenTypes.IDENTIFIER, JavaScriptBundle.message("javascript.parser.message.expected.identifier"));
				}
			}
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.THROW_KEYWORD);
		final PsiBuilder.Marker statement = builder.mark();
		builder.advanceLexer();
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.SWITCH_KEYWORD);
		final PsiBuilder.Marker statement = builder.mark();
		builder.advanceLexer();
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.WITH_KEYWORD);
		final PsiBuilder.Marker statement = builder.mark();
		builder.advanceLexer();
	...
	protected void parseIterationStatement(final PsiBuilder builder)
	{
		...
		{
			LOGGER.error("Unknown iteration statement");
		}
	}

	private void parseForStatement(final PsiBuilder builder)
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.FOR_KEYWORD);
		final PsiBuilder.Marker statement = builder.mark();
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.WHILE_KEYWORD);
		final PsiBuilder.Marker statement = builder.mark();
		builder.advanceLexer();
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.DO_KEYWORD);
		final PsiBuilder.Marker statement = builder.mark();
		builder.advanceLexer();

		parseStatement(builder);
		checkMatches(builder, JSTokenTypes.WHILE_KEYWORD, JavaScriptBundle.message("javascript.parser.message.expected.while.keyword"));
		checkMatches(builder, JSTokenTypes.LPAR, JavaScriptBundle.message("javascript.parser.message.expected.lparen"));
		getExpressionParsing().parseExpression(builder);
		checkMatches(builder, JSTokenTypes.RPAR, JavaScriptBundle.message("javascript.parser.message.expected.rparen"));
		checkForSemicolon(builder);
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.IF_KEYWORD);
	...
	{
		LOGGER.assertTrue(builder.getTokenType() == JSTokenTypes.SEMICOLON);
		final PsiBuilder.Marker statement = builder.mark();
		builder.advanceLexer();
	...
	protected void parseVarStatementNoMarker(final PsiBuilder builder, final boolean inForInitializationContext, final @NotNull PsiBuilder.Marker var)
	{
		...
		while(true)
		{
			...
			{
				checkMatches(builder, JSTokenTypes.COMMA, JavaScriptBundle.message("javascript.parser.message.expected.comma"));
			}
