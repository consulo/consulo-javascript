    ...
    private JavaScriptHighlightingLexer(Supplier<Lexer> baseLexerFactory, boolean withEmbeddments) {
        ...
        if (withEmbeddments) {
            registerSelfStoppingLayer(
                new StringLiteralLexer('\"', JSTokenTypes.STRING_LITERAL, true, "/"),
                new IElementType[]{JSTokenTypes.STRING_LITERAL},
                IElementType.EMPTY_ARRAY
            );

            registerSelfStoppingLayer(
                new JavaScriptHighlightingLexer(baseLexerFactory, false),
                new IElementType[]{JSTokenTypes.XML_JS_SCRIPT},
                IElementType.EMPTY_ARRAY
            );
            ...
            // since it causes token type collision in javascript embedded to html
            docLexer.registerLayer(
                new LexerBase() {
