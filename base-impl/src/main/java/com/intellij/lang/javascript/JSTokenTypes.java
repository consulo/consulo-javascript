...
public interface JSTokenTypes {
    ...
    TokenSet JS2_KEYWORDS = TokenSet.create(
        AS_KEYWORD,
        CLASS_KEYWORD,
        DYNAMIC_KEYWORD,
        EACH_KEYWORD,
    ...
    TokenSet ECMASCRIPT6_STRICT_KEYWORDS = TokenSet.create(
        IMPLEMENTS_KEYWORD,
        INTERFACE_KEYWORD,
        PACKAGE_KEYWORD,
        PRIVATE_KEYWORD,
    ...
    IElementType MULT_MULT_EQ = new JSElementType("MULT_MULT_EQ");// **=
    ...
    TokenSet OPERATIONS = TokenSet.create(
        ...
        PLUS, MINUS, MULT, PERC,
        PLUSPLUS, MINUSMINUS, LTLT,
        GTGT, GTGTGT, AND, OR, XOR,
        EXCL, TILDE, ANDAND, OROR,
        QUEST, COLON, EQ, PLUSEQ,
        MINUSEQ, MULTEQ, PERCEQ, LTLTEQ,
        GTGTEQ, GTGTGTEQ, ANDEQ, OREQ,
        XOREQ, DIV, DIVEQ, MULTMULT,
        COMMA, IS_KEYWORD, AS_KEYWORD,
        OR_OR_EQ, AND_AND_EQ, QUEST_QUEST_EQ, MULT_MULT_EQ
    );
    ...
    TokenSet UNARY_OPERATIONS =
        TokenSet.create(PLUS, MINUS, PLUSPLUS, MINUSMINUS, TILDE, EXCL, TYPEOF_KEYWORD, VOID_KEYWORD, DELETE_KEYWORD);
    ...
    TokenSet COMMENTS = TokenSet.create(
        ...
        DOC_COMMENT,
        END_OF_LINE_COMMENT,
        JavaScriptHighlightingLexer.getTagContentTokenType(),
        JSDOC_TAG_DATA,
        JSP_TEXT,
        XML_STYLE_COMMENT,
        XML_STYLE_COMMENT_START,
        XML_TAG_WHITE_SPACE
    );
