...
public class JSUtils {
    public static boolean isLHSExpression(JSExpression expr) {
        if (expr instanceof JSDefinitionExpression definition) {
            expr = definition.getExpression();
        }
        ...
        if (expr instanceof JSParenthesizedExpression parenthesizedExpression) {
            return isLHSExpression(parenthesizedExpression.getInnerExpression());
        }
